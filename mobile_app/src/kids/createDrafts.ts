...
export function draftHasContent(draft: Pick<CreateDraft, 'caption' | 'tags' | 'location' | 'media'>): boolean {
  return Boolean(draft.media || draft.caption.trim() || draft.tags.trim() || draft.location.trim());
}
