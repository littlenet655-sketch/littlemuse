...
/** Server-backed page size for the conversations list. */
const PAGE_SIZE = 20;
...
export function ConversationsScreen({ navigation }: ChildScreenProps<'KidsTabs'>) {
  ...
  // Backend already orders newest-first; keep a defensive client sort so
  // merges remain stable if two pages arrive around the same timestamp.
