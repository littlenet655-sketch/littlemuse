...
export const routes = {
  ...
  storyReaction: (storyId: number) => `/api/mobile/v2/kids/stories/${storyId}/reaction`,
  storyReply: (storyId: number) => `/api/mobile/v2/kids/stories/${storyId}/reply`,
  ...
  deleteComment: (postId: number, commentId: number) => `/api/mobile/v1/kids/posts/${postId}/comments/${commentId}`,
  commentsSetting: (postId: number) => `/api/mobile/v1/kids/posts/${postId}/comments-setting`,
