...
function ChildNavigator() {
  ...
  return (
    <ChildStack.Navigator initialRouteName={initialRoute} screenOptions={cleanStackOptions}>
      ...
      <ChildStack.Screen name="NotificationsTab" component={withGateSync(NotificationsScreen)} options={{ title: 'Notifications', headerShown: false }} />
      <ChildStack.Screen name="Conversations" component={withGateSync(ConversationsScreen)} options={{ title: 'Messages', headerShown: false }} />
      ...
      <ChildStack.Screen name="ProcessingStatus" component={withGateSync(ProcessingStatusScreen)} options={{ title: 'Safety check', headerShown: false }} />
