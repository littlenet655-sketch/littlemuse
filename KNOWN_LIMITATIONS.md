...
7. **Bounded video moderation** — the release policy intentionally caps visual moderation at 8 scene-aware/uniform frames. With the default 12-second temporal-gap contract, videos up to 84 seconds can satisfy automatic coverage; videos longer than 84 seconds are intentionally REVIEW-only rather than being silently auto-published from sparse evidence.
