...
The scope includes Kids/Parent/Admin modes; feed/posts/reels/stories/chat; approved social interaction; discover; text/PII and visual safety; parent review; screen time and quiet hours; alerts; personalization; quizzes/learning; private R2 media; PostgreSQL audit data; React Native mobile source; and Modal AI deployment.

Standalone audio/voice moderation is outside the locked runtime. Video safety uses a bounded 3–8 frame PySceneDetect + time-distributed sample; clips with insufficient temporal coverage remain private for REVIEW.
